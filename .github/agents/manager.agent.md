...
# 全ディレクトリを一括作成
mkdir -p "$REQUEST_DIR"/{01_調査,02_設計,03_計画,04_実行}
...
**成果物出力先**: `${REQUEST_DIR}/04_実行/{タスク識別子}/`
...
- **完了時刻**: -
- **前提条件**: task03
- **成果物出力先**: `{REQUEST_DIR}/04_実行/task04-01/`
- **依頼内容**: [依頼プロンプト概要]
- **結果概要**: [進行中...]
...
- **完了時刻**: -
- **前提条件**: task03
- **成果物出力先**: `{REQUEST_DIR}/04_実行/task04-02/`
- **依頼内容**: [依頼プロンプト概要]
- **結果概要**: [進行中...]
