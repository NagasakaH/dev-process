...
- `dev-investigation` - 開発タスク用詳細調査（setup.yaml の description.background を参照）
- `dev-design` - 設計（setup.yaml の description.requirements を参照）
- `dev-plan` - タスク計画（setup.yaml の description.acceptance_criteria を参照）
