...
- [design/01_implementation-approach.md](../design/01_implementation-approach.md)
- [design/02_interface-api-design.md](../design/02_interface-api-design.md)
- [design/03_data-structure-design.md](../design/03_data-structure-design.md)
- [design/04_process-flow-design.md](../design/04_process-flow-design.md)
...
- [design/05_test-plan.md](../design/05_test-plan.md)
...
- [design/06_side-effect-verification.md](../design/06_side-effect-verification.md)
...
1. 上記テンプレートを `plan/task{XX}.md` にコピー
2. `{...}` 部分を実際の値に置き換え
