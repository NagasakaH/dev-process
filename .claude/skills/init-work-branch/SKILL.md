...
- スキル内参照: `/.claude/skills/init-work-branch/references/setup-template.yaml`
...
2. investigation スキルで調査を実施（setup.yaml の description.background を参照）
3. design スキルで設計を実施（setup.yaml の description.requirements を参照）
```
